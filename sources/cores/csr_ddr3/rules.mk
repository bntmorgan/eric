...
SRC_$(d)				:= $(d)/rtl/csr_ddr3_top.v $(d)/rtl/csr_ddr3_ctlif.v \
	$(d)/rtl/csr_ddr3_psync.v
...
SIM 			      := $(call SRC_2_BIN, $(d)/csr_ddr3_top.sim)
SRC_SIM_$(d)		:= $(SRC_$(d)) $(d)/rtl/sim_csr_ddr3_top.v
$(SIM)					: $(SRC_SIM_$(d))
$(SIM)					: SIM_CFLAGS := -I$(d)/rtl
SIMS						+= $(SIM)
